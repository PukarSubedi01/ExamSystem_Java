...
public ArrayList<QandA> javaQuestionData() throws SQLException{
	...
	String query="Select question,option1,option2,option3,option4,answer from java_question";
	dbConnection dbc = new dbConnection();
	ResultSet rs = dbc.fetchingData(query);
	QandA qa;
	while (rs.next()) {
		qa = new QandA(rs.getString("question"), rs.getString("option1"), rs.getString("option2"), 
...
public ArrayList<QandA> pythonQuestionData() throws SQLException{
	...
	String query="Select question,option1,option2,option3,option4,answer from python_question";
	dbConnection dbc = new dbConnection();
	ResultSet rs = dbc.fetchingData(query);
	QandA qa;
	while (rs.next()) {
...
public ArrayList<QandA> cSharpQuestionData() throws SQLException{
	...
	String query="Select question,option1,option2,option3,option4,answer from c_question";
	dbConnection dbc = new dbConnection();
	ResultSet rs = dbc.fetchingData(query);
	QandA qa;
	while (rs.next()) {
...
public ArrayList<QandA> jsQuestionData() throws SQLException{
	...
	String query="Select question,option1,option2,option3,option4,answer from javascript_question";
	dbConnection dbc = new dbConnection();
	ResultSet rs = dbc.fetchingData(query);
	QandA qa;
	while (rs.next()) {
